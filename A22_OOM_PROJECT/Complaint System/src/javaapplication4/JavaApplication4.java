...
import java.io.IOException;
import java.util.ArrayList;
import static javaapplication4.dbms.id;
import javax.imageio.ImageIO;
...
public class JavaApplication4 extends dbms{
    //Complaint form
    ...
    static <a> void thirdFrame(){
        ...
        f2.setVisible(true);
        try {
            f2.setContentPane(new JLabel(new ImageIcon(ImageIO.read(new File("C:\\Users\\Prernendu Bhagat\\Documents\\NetBeansProjects\\JavaApplication4\\src\\javaapplication4\\form.jpg")))));
        } catch (IOException e) {
            e.printStackTrace();
        }
        JLabel lab = new JLabel("<html><font color='black'>COMPLAINT FORM</font></html>");
        lab.setFont(new Font("Helvetica", Font.BOLD, 40));
        lab.setBounds(50, 10, 1000, 100);
        f2.add(lab);

        //form contents
        String[] optionsToChoose = {"Electrical", "Civil Work", "Water Service", "Electronic", "Drainage", "Infrastructure Maintainance"};
        JLabel l01 = new JLabel("<html><font color='black'>Block: </font></html>");
//        String[] optionsToChoose1 = {"CC1", "CC2", "CC3", "SAC", "Library", "LT","BH1","BH2","BH3","BH4","BH5","RSA","GH1","GH2","GH3","STAFF"};
        JTextField tf1 = new JTextField();
        JLabel l02 = new JLabel("<html><font color='black'>Room number: </font></html>");
        JTextField tf2 = new JTextField();
        JLabel l03 = new JLabel("<html><font color='black'>Date of availability<br>[dd-mm-yy]: </font></html>");
        ...
        //drop-down
        JLabel l04 = new JLabel("<html><font color='black'>Select Department:</font></html>");
        l04.setBounds(50, 250, 100, 50);
        JComboBox<String> jcb = new JComboBox<>(optionsToChoose);
        jcb.setBounds(50, 295, 140, 20);

        JLabel l05 = new JLabel("<html><font color='black'>Complaint details:</font></html>");
    ...
    static void Fframe(){
        ...
        f4.setVisible(true);
        try {
            f4.setContentPane(new JLabel(new ImageIcon(ImageIO.read(new File("C:\\Users\\Prernendu Bhagat\\Documents\\NetBeansProjects\\JavaApplication4\\src\\javaapplication4\\form.jpg")))));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//        ff.add(sp);
    ...
    static void forthFrame(){
        ...
        //form contents
        JLabel l01 = new JLabel("<html><font color='black'>Student Name:  </font></html>");
        JTextField tf1 = new JTextField();
        JLabel l02 = new JLabel("<html><font color='black'>Email ID: </font></html>");
        JTextField tf2 = new JTextField();
        JLabel l03 = new JLabel("<html><font color='black'>Password: </font></html>");
        JTextField tf3 = new JTextField();
        JLabel l04 = new JLabel("<html><font color='black'>Room no.: </font></html>");
    ...
    static void newFrame(JFrame f){
        ...
        f1.setVisible(true);
        try {
            f1.setContentPane(new JLabel(new ImageIcon(ImageIO.read(new File("C:\\Users\\Prernendu Bhagat\\Documents\\NetBeansProjects\\JavaApplication4\\src\\javaapplication4\\collegeBackground.jpg")))));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        JLabel label = new JLabel("WELCOME TO COLLEGE COMPLAINT SYSTEM");
    ...
    //login page
        ...
        JLabel l1 = new JLabel("<html><font color='white'>LOGIN</font></html>");
      ...
      p2.setBackground(Color.darkGray);
        ...
        b.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e){
                ...
                else if(tf1.getText().equals("admin@iiita.ac.in") && s.equals("Admin")){
                    nextFrame(f);
                    f.setVisible(false);
                    pf.setText("");
                }
